package edu.programacion.avanzada.juniorperalta.ProyectoFinal.controllers;

import edu.programacion.avanzada.juniorperalta.ProyectoFinal.model.request.address.CreateAddressRequest;
import edu.programacion.avanzada.juniorperalta.ProyectoFinal.model.request.address.DeleteAddressRequest;
import edu.programacion.avanzada.juniorperalta.ProyectoFinal.model.request.address.UpdateAddressRequest;
import edu.programacion.avanzada.juniorperalta.ProyectoFinal.model.request.checkout.CheckoutAddProductReq;
import edu.programacion.avanzada.juniorperalta.ProyectoFinal.model.request.checkout.CheckoutUAddressReq;
import edu.programacion.avanzada.juniorperalta.ProyectoFinal.model.request.checkout.CheckoutUPaymentMReq;
...
import edu.programacion.avanzada.juniorperalta.ProyectoFinal.model.response.checkout.CheckoutAddProductRes;
import edu.programacion.avanzada.juniorperalta.ProyectoFinal.model.response.checkout.CheckoutUAddressRes;
import edu.programacion.avanzada.juniorperalta.ProyectoFinal.model.response.checkout.CheckoutUPaymentMRes;
import edu.programacion.avanzada.juniorperalta.ProyectoFinal.model.response.checkout.GetCheckoutResponse;
import edu.programacion.avanzada.juniorperalta.ProyectoFinal.model.response.payment.CreatePaymentMResponse;
import edu.programacion.avanzada.juniorperalta.ProyectoFinal.services.AddressService;
import edu.programacion.avanzada.juniorperalta.ProyectoFinal.services.CheckoutService;
